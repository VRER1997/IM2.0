...
public class VoiceCallActivity extends CallActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (!isInComingCall) {// 拨打电话
			...
			st1 = "are_connected_to_each_other";
                ...
                case DISCONNECTED: // 电话断了
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            String st2 = "the_other_party_refused_to_accept";
                            String st3 = "connection_failure";
                            String st4 = "the_other_party_is_not_online";
                            String st5 = "the_other_is_on_the_phone_please";
                            
                            String st6 = "the_other_party_did_not_answer";
                            String st7 = getResources().getString(R.string.hang_up);
                            String st8 = "the_other_is_hang_up";
                            
                            String st9 = getResources().getString(R.string.did_not_answer);
                            String st10 = "has_been_cancelled";
